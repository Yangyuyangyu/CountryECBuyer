...
/**
 * Created by Administrator on 2016/6/13.测量手指滑动距离
 */
    ...
    private Handler checkStateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (lastT == getScrollY()) {
                ...
                onScrollListener.onScrollStateChanged(MyScrollView.this,
...
//                    Log.d(TAG, "没有到最下方");
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(MyScrollView view,
                                         int scrollState);
