package com.countryecbuyer.adapter.base;
...
public abstract class SolidRVBaseAdapter<T> extends RecyclerView.Adapter<SolidRVBaseAdapter.SolidCommonViewHolder> {
    ...
    public class SolidCommonViewHolder extends
         ...
         * 是否可点击
         */
        public SolidCommonViewHolder setIsClick(int viewId, boolean isclick) {
         ...
         * 设置背景色
         */
        public SolidCommonViewHolder setViewColor(int viewId, int color) {
            View view = getView(viewId);
